...
const id: Translations = {
        ...
        features: [
            {
                ...
                description:
                    "Merancang dan mengembangkan aplikasi web skalabel menggunakan framework modern seperti React.js, Next.js, Node.js, dan Laravel.",
            },
            {
                title: "Pemecahan masalah full-stack",
                description:
                    "Berpengalaman di frontend dan backend — mengubah logika bisnis menjadi kode yang efisien dan mudah dipelihara.",
            },
            {
                title: "Kolaborasi & pertumbuhan",
                description:
                    "Berkembang dalam tim agile — code review, sesi pairing, dan diskusi terbuka yang meningkatkan kualitas dan sinergi tim.",
            },
            {
                title: "Pembelajaran berkelanjutan",
                description:
                    "Bersemangat menjelajahi teknologi baru, mengoptimalkan sistem, dan berbagi pengetahuan untuk mendorong inovasi.",
            },
        ],
    },
    collaboration: {
        ...
        cta: "Ayo Berkolaborasi",
    },
    wakatime: {
        totalCoding: "Total Waktu Coding:",
        hours: "+ Jam",
        since: "Sejak",
    ...
    notFound: {
        ...
        description:
            "Sepertinya halaman ini tersesat. Mari kita kembalikan kamu ke tempat yang familiar.",
